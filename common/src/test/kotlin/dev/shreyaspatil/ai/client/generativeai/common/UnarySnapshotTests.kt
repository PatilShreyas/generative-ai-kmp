...
internal class UnarySnapshotTests {
    ...
    @Test
    fun `short reply`() = goldenUnaryFile("success-basic-reply-short.json") {
    ...
    @Test
    fun `long reply`() = goldenUnaryFile("success-basic-reply-long.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `unknown enum`() = goldenUnaryFile("success-unknown-enum.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `safetyRatings including severity`() = goldenUnaryFile("success-including-severity.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `prompt blocked for safety`() = goldenUnaryFile("failure-prompt-blocked-safety.json") {
        withTimeout(testTimeout) {
    ...
    @Test
    fun `empty content`() = goldenUnaryFile("failure-empty-content.json") {
        withTimeout(testTimeout) {
    ...
    @Test
    fun `http error`() = goldenUnaryFile("failure-http-error.json", HttpStatusCode.PreconditionFailed) {
        withTimeout(testTimeout) {
    ...
    @Test
    fun `user location error`() = goldenUnaryFile("failure-unsupported-user-location.json", HttpStatusCode.PreconditionFailed) {
        withTimeout(testTimeout) {
    ...
    @Test
    fun `stopped for safety`() = goldenUnaryFile("failure-finish-reason-safety.json") {
        withTimeout(testTimeout) {
            val exception =
    ...
    @Test
    fun `citation returns correctly`() = goldenUnaryFile("success-citations.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `citation returns correctly with missing license and startIndex`() = goldenUnaryFile("success-citations-nolicense.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `response includes usage metadata`() = goldenUnaryFile("success-usage-metadata.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `response includes partial usage metadata`() = goldenUnaryFile("success-partial-usage-metadata.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `citation returns correctly when using alternative name`() = goldenUnaryFile("success-citations-altname.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `properly translates json text`() = goldenUnaryFile("success-constraint-decoding-json.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `invalid response`() = goldenUnaryFile("failure-invalid-response.json") {
        withTimeout(testTimeout) {
            shouldThrow<SerializationException> {
                apiController.generateContent(textGenerateContentRequest("prompt"))
            }
    ...
    @Test
    fun `malformed content`() = goldenUnaryFile("failure-malformed-content.json") {
        withTimeout(testTimeout) {
            shouldThrow<SerializationException> {
                apiController.generateContent(textGenerateContentRequest("prompt"))
            }
    ...
    @Test
    fun `invalid api key`() = goldenUnaryFile("failure-api-key.json", HttpStatusCode.BadRequest) {
        withTimeout(testTimeout) {
    ...
    @Test
    fun `quota exceeded`() = goldenUnaryFile("failure-quota-exceeded.json", HttpStatusCode.BadRequest) {
        withTimeout(testTimeout) {
    ...
    @Test
    fun `image rejected`() = goldenUnaryFile("failure-image-rejected.json", HttpStatusCode.BadRequest) {
        withTimeout(testTimeout) {
            shouldThrow<ServerException> {
                apiController.generateContent(textGenerateContentRequest("prompt"))
            }
    ...
    @Test
    fun `unknown model`() = goldenUnaryFile("failure-unknown-model.json", HttpStatusCode.NotFound) {
        withTimeout(testTimeout) {
            shouldThrow<ServerException> {
                apiController.generateContent(textGenerateContentRequest("prompt"))
            }
    ...
    @Test
    fun `service disabled`() = goldenUnaryFile("failure-service-disabled.json", HttpStatusCode.Forbidden) {
        withTimeout(testTimeout) {
    ...
    @Test
    fun `function call contains null param`() = goldenUnaryFile("success-function-call-null.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `function call contains json literal`() = goldenUnaryFile("success-function-call-json-literal.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
    ...
    @Test
    fun `function call has no arguments field`() = goldenUnaryFile("success-function-call-empty-arguments.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
            val content = response.candidates.shouldNotBeNullOrEmpty().first().content
    ...
    @Test
    fun `code execution parses correctly`() = goldenUnaryFile("success-code-execution.json") {
        withTimeout(testTimeout) {
            val response = apiController.generateContent(textGenerateContentRequest("prompt"))
            val content = response.candidates.shouldNotBeNullOrEmpty().first().content
            content.shouldNotBeNull()
